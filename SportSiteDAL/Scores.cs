    ...
    public class Scores
    {
        ...
        public DataTable GetCurrentMatches()
        {
            ...
            string sqlQuery = "SELECT " +
                             ...
                             " ,[Team1Score] " +
                             " ,[Team2Score] " +
                             " ,(SELECT TOP 1 Teams.Name FROM Teams WHERE Teams.Id = m.Team1) as Team1Name " +
                             " ,(SELECT TOP 1 Teams.Name FROM Teams WHERE Teams.Id = m.Team2) as Team2Name " +
                             " ,m.GameID " +
                             " ,m.MatchDate " +
	  ...
	  " Else (SELECT Teams.Name FROM Teams WHERE Teams.Id = m.Team2) END) as Winner" +  
                              " FROM [Scores] s  " +
                              " join Matches m on  m.Id  = s.MatchID  join games g on m.GameID = g.Id order by m.MatchDate desc";
