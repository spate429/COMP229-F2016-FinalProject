...
<asp:Content runat="server" ID="FeaturedContent" ContentPlaceHolderID="contentmain">
  ...
  <div class="title">
			...
			<p> This is Sport Portal. It creates sports experiences, connecting fans to what they love through an addictive combination of real-time scores and fantasy information while creating and curating content that is mobile optimized, comprehensive, customizable and seamlessly shareable.
:) </p>
    ...
    <div class="clearfix"></div>
        ...
        PagerStyle-CssClass="pager"
                  OnPageIndexChanging="DetailsView1_PageIndexChanging">
                    <Fields>
                        <asp:BoundField DataField="GameName" HeaderText="Game" SortExpression="GameName" />
                        ...
                        <asp:HyperLinkField HeaderText="Details" Text="Get details score" DataNavigateUrlFields="MatchURL" />
                    </Fields>
		...
		<div id="box3"> <a href="#"><img src="assets/pic03.jpg" alt=""></a>
			<h2 class="subtitle">Football</h2>
			<p>Football is a family of team sports that involve, to varying degrees, kicking a ball with the foot to score a goal. Unqualified, the word football is understood to refer to whichever form of football is the most popular in the regional context in which the word appears.</p>
			<ul class="contact">
				<li><a href="#" class="icon icon-facebook"><span></span></a></li>
				<li><a href="#" class="icon icon-dribbble"><span>Pinterest</span></a></li>
				<li><a href="#" class="icon icon-tumblr"><span>Google+</span></a></li>
